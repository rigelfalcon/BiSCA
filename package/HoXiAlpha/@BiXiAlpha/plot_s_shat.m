function plot_s_shat(self)
    ...
    h_fit  = plot(self.f, 10 * log10(self.shat), 'Color', c_fit,  'LineWidth', LineWidth, 'MarkerSize', MarkerSize, 'DisplayName', 'BiSCA spectrum');
    ...
    smax = max(10 * [log10(mean(self.s, 2)); log10(self.shat)], [], 'all');
    ...
    if length(self.para_alpha.kernel.para.mu) == self.ks + self.k0 + self.kh
